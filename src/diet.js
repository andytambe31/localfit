...
export const DEFAULT_PANTRY = [
  ...
  // --- goal-optimal staples (the "buy these" catalog) -----------------------
  // High-protein / high-fiber whole foods tuned to the recomp. Each carries the
  // pantry "intelligence": perishability, shelf days, storage, freezable, burn
  // rate, bulk-buy, goalRank (1 = best), costTier. staple:true marks the catalog.
  { id: 'salmon',        name: 'Salmon',            loc: 'home', category: 'protein',   portion: '100g cooked', kcal: 206, protein: 22, carbs: 0,  fat: 13,  fiber: 0,   sugar: 0, staple: true, perishability: 'fresh',  shelfDays: 3,   storage: 'fridge',  freezable: true,  burnRate: 'weekly',  bulk: false, goalRank: 1, costTier: 'high' },
  { id: 'canned_tuna',   name: 'Canned Tuna',       loc: 'both', category: 'protein',   portion: '1 can drained', kcal: 116, protein: 26, carbs: 0, fat: 1, fiber: 0,   sugar: 0, staple: true, perishability: 'stable', shelfDays: 730, storage: 'pantry',  freezable: false, burnRate: 'monthly', bulk: true,  goalRank: 1, costTier: 'low' },
  { id: 'sardines',      name: 'Sardines',          loc: 'home', category: 'protein',   portion: '1 tin',       kcal: 191, protein: 23, carbs: 0,  fat: 11,  fiber: 0,   sugar: 0, staple: true, perishability: 'stable', shelfDays: 730, storage: 'pantry',  freezable: false, burnRate: 'monthly', bulk: true,  goalRank: 1, costTier: 'low' },
  { id: 'ground_turkey', name: 'Lean Ground Turkey',loc: 'home', category: 'protein',   portion: '100g cooked', kcal: 176, protein: 22, carbs: 0,  fat: 9,   fiber: 0,   sugar: 0, staple: true, perishability: 'fresh',  shelfDays: 3,   storage: 'fridge',  freezable: true,  burnRate: 'weekly',  bulk: false, goalRank: 1, costTier: 'med' },
  { id: 'lean_beef_93',  name: '93% Lean Beef',     loc: 'home', category: 'protein',   portion: '100g cooked', kcal: 182, protein: 25, carbs: 0,  fat: 9,   fiber: 0,   sugar: 0, staple: true, perishability: 'fresh',  shelfDays: 4,   storage: 'fridge',  freezable: true,  burnRate: 'weekly',  bulk: false, goalRank: 1, costTier: 'med' },
  { id: 'shrimp',        name: 'Shrimp',            loc: 'home', category: 'protein',   portion: '100g cooked', kcal: 99,  protein: 24, carbs: 0,  fat: 0.3, fiber: 0,   sugar: 0, staple: true, perishability: 'fresh',  shelfDays: 2,   storage: 'freezer', freezable: true,  burnRate: 'monthly', bulk: true,  goalRank: 1, costTier: 'high' },
  { id: 'tofu',          name: 'Firm Tofu',         loc: 'home', category: 'protein',   portion: '100g',        kcal: 144, protein: 17, carbs: 3,  fat: 9,   fiber: 2,   sugar: 1, staple: true, perishability: 'fridge', shelfDays: 10,  storage: 'fridge',  freezable: true,  burnRate: 'weekly',  bulk: false, goalRank: 2, costTier: 'low' },
  { id: 'egg_whites',    name: 'Egg Whites',        loc: 'home', category: 'protein',   portion: '1/2 cup (~120g)', kcal: 63, protein: 13, carbs: 1, fat: 0, fiber: 0,   sugar: 0, staple: true, perishability: 'fridge', shelfDays: 14,  storage: 'fridge',  freezable: false, burnRate: 'weekly',  bulk: false, goalRank: 1, costTier: 'low' },
  { id: 'rolled_oats',   name: 'Rolled Oats',       loc: 'home', category: 'side',      portion: '1/2 cup dry (40g)', kcal: 150, protein: 5, carbs: 27, fat: 3, fiber: 4,   sugar: 1, staple: true, perishability: 'stable', shelfDays: 365, storage: 'pantry',  freezable: false, burnRate: 'monthly', bulk: true,  goalRank: 1, costTier: 'low' },
  { id: 'quinoa',        name: 'Quinoa',            loc: 'home', category: 'side',      portion: '1 cup cooked', kcal: 222, protein: 8,  carbs: 39, fat: 4,   fiber: 5,   sugar: 1.6, staple: true, perishability: 'stable', shelfDays: 730, storage: 'pantry',  freezable: false, burnRate: 'monthly', bulk: true,  goalRank: 1, costTier: 'med' },
  { id: 'brown_rice',    name: 'Brown Rice',        loc: 'home', category: 'side',      portion: '1 cup cooked', kcal: 216, protein: 5,  carbs: 45, fat: 1.8, fiber: 3.5, sugar: 0, staple: true, perishability: 'stable', shelfDays: 730, storage: 'pantry',  freezable: false, burnRate: 'monthly', bulk: true,  goalRank: 2, costTier: 'low' },
  { id: 'red_lentils',   name: 'Red Lentils',       loc: 'home', category: 'side',      portion: '1 cup cooked', kcal: 230, protein: 18, carbs: 40, fat: 0.8, fiber: 16,  sugar: 4, staple: true, perishability: 'stable', shelfDays: 730, storage: 'pantry',  freezable: false, burnRate: 'monthly', bulk: true,  goalRank: 1, costTier: 'low' },
  { id: 'chickpeas',     name: 'Chickpeas',         loc: 'home', category: 'side',      portion: '1 cup cooked', kcal: 269, protein: 15, carbs: 45, fat: 4,   fiber: 13,  sugar: 8, staple: true, perishability: 'stable', shelfDays: 730, storage: 'pantry',  freezable: false, burnRate: 'monthly', bulk: true,  goalRank: 1, costTier: 'low' },
  { id: 'spinach',       name: 'Spinach',           loc: 'home', category: 'vegetable', portion: '100g',        kcal: 23,  protein: 2.9, carbs: 3.6, fat: 0.4, fiber: 2.2, sugar: 0.4, staple: true, perishability: 'fresh', shelfDays: 5, storage: 'fridge', freezable: true, burnRate: 'weekly', bulk: false, goalRank: 1, costTier: 'low' },
  { id: 'bell_pepper',   name: 'Bell Pepper',       loc: 'home', category: 'vegetable', portion: '1 medium',    kcal: 31,  protein: 1,   carbs: 7,   fat: 0.3, fiber: 2.5, sugar: 4.2, staple: true, perishability: 'fresh', shelfDays: 10, storage: 'fridge', freezable: false, burnRate: 'weekly', bulk: false, goalRank: 1, costTier: 'low' },
  { id: 'asparagus',     name: 'Asparagus',         loc: 'home', category: 'vegetable', portion: '100g',        kcal: 20,  protein: 2.2, carbs: 4,   fat: 0.1, fiber: 2,   sugar: 1.9, staple: true, perishability: 'fresh', shelfDays: 5, storage: 'fridge', freezable: false, burnRate: 'weekly', bulk: false, goalRank: 1, costTier: 'med' },
  ...
  { id: 'masala_dosa',       name: 'Masala Dosa',           loc: 'outside', category: 'restaurant_meal', portion: '1 dosa',      kcal: 620,  protein: 11, carbs: 90,  fat: 24, fiber: 6, sugar: 5,  travel: true },
  { id: 'special_uttapam',   name: 'Special Uttapam',       loc: 'outside', category: 'restaurant_meal', portion: '1 uttapam',   kcal: 580,  protein: 13, carbs: 84,  fat: 20, fiber: 6, sugar: 7,  travel: true },
  { id: 'veg_samosa',        name: 'Samosa',                loc: 'outside', category: 'restaurant_meal', portion: '1 samosa',    kcal: 330,  protein: 6,  carbs: 36,  fat: 18, fiber: 3, sugar: 2,  travel: true, unhealthy: true },
  { id: 'salted_butter_oat_latte', name: 'Salted Butter Oat Latte', loc: 'outside', category: 'beverage', portion: '1 small',  kcal: 340,  protein: 3,  carbs: 34,  fat: 20, fiber: 0, sugar: 26, travel: true, unhealthy: true },
  { id: 'buttered_soft_serve', name: 'Buttered Vanilla Soft Serve', loc: 'outside', category: 'dessert', portion: '1 serving', kcal: 600,  protein: 7,  carbs: 54,  fat: 38, fiber: 0, sugar: 46, travel: true, unhealthy: true },
